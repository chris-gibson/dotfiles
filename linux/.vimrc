...
" source /home/cgibson/.vim/vimrcs/neobundle-setup.vim
...
if has('vim_starting')
  ...
  " Required:
  set runtimepath+=/home/cgibson/.vim/bundle/neobundle.vim/
endif

" Required:
call neobundle#begin(expand('/home/cgibson/.vim/bundle'))
